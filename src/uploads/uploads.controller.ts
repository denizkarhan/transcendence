import { Controller, FileTypeValidator, Get, HttpException, HttpStatus, MaxFileSizeValidator, ParseFilePipe, Post, Request, UploadedFile, UseInterceptors, UsePipes } from '@nestjs/common';
...
export class UploadsController {
    ...
    async uploadFile(@UploadedFile() file: Express.Multer.File, @Request() req) {
        ...
        ava.path = file.path;
        ava.user = await this.userService.getUserById(req.user.Id);
