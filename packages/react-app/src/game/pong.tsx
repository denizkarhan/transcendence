...
function Game() {
	...
	useEffect(() => {
		...
		if (!context)
			return;
		canvas.socket = io("http://k2m13s05.42kocaeli.com.tr:3001", {
			auth: {
		...
		// addTextToPage("<Pong Game>" + " | User ID: ");
	...
	return (
		<div>
			<div id='lobi-container' style={{ cursor: 'default' }}>
				<h1>Boş Odalar</h1>
			...
			<div id='button-div'>
				<Button>Lobiye Dön</Button>
			</div>
			<div id="text-container"></div>
			<canvas ref={canvasRef} id="pongGame" style={{ backgroundColor: 'black', cursor: 'default' }}></canvas>
		</div>
	);
